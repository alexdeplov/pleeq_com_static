...
# Configuration
image_folder = "/Users/alexander/GitHub/pleeq_com_static/rss/games/" 
rss_file = "rss.xml"
...
def process_image(image_path):
    ...
    <link>https://pleeq.com/rss/games/{filename}.jpg</link> 
    <pubDate>{creation_date}</pubDate>
    <description>{image_description}</description>
    <guid>{filename_with_underscores}</guid>  
    <enclosure url="https://pleeq.com/rss/games/{filename}.jpg" type="image/jpeg"/> 
  </item>
"""
        return item_str
...
# Write to RSS file
with open("/Users/alexander/GitHub/pleeq_com_static/rss/games.xml", "w", encoding="utf-8") as f:
    f.write(rss_content)
